...
@CjService(name = "/wechat/app_pay_notify.html")
public class WechatpayAppPayNotifyUrlWebView implements IGatewayAppSiteWayWebView {
    @CjServiceRef
...
//                CJSystem.logging().info(getClass(), data);
                ...
                CJSystem.logging().info(WechatpayAppPayNotifyUrlWebView.this.getClass(), String.format("\nkey:%s,\nassociated_data:%s,\nciphertext:%s,\nnonce:%s", key, associated_data, ciphertext, nonce));
                ...
                try {
                    ...
                    CJSystem.logging().info(WechatpayAppPayNotifyUrlWebView.this.getClass(), message.getOut_trade_no());
                    ...
                    writeFail(circuit);
                    CJSystem.logging().error(WechatpayAppPayNotifyUrlWebView.this.getClass(), e);
                }
            }
        });
    }
